...
/**
 * Mineshaft is a demonstration application that builds a mouse maze, displays
...
public class Mineshaft {
    /**
     * Launches Mineshaft. The maze to use depend on what is provided via
    ...
    private static void displayUsageMessage() {
        System.out.println("Usage: java Mineshaft <Steve x> <Steve y> <pig x> <pig y>");
        System.out.println();
        ...
        System.out.println();
        System.out.println("    java Mineshaft 0 0 5 5 < six-by-six.maze.txt");
        System.out.println();
